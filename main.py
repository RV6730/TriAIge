...
async def startup_event():
    print("[TriAIge] Application starting up...")
    print(f"[TriAIge] Current working directory: {os.getcwd()}")
    print(f"[TriAIge] Files in current directory: {os.listdir('.')}")
    if os.path.exists("../dist"):
        print(f"[TriAIge] Found dist folder at ../dist")
    else:
        print(f"[TriAIge] ERROR: dist folder not found at ../dist")
